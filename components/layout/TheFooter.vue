    ...
    <div class="mx-auto space-t-8">
      ...
      <div class="bg-[#FBF9F4] md:flex md:flex-row  w-full text-center pt-8 pb-2">
        ...
        <div class="md:w-1/4">
          ...
          <p class="text-[#1e1e1e] text-base font-lora">
            665 Route des bains <br/>
            74250 Menthon <br/>
          ...
          <div class="flex justify-center p-3 gap-4">
            <div
              ...
              <svg width="22" height="27" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div
                class="w-12 h-12 md:w-10 md:h-10 bg-[#4b6447] rounded-full flex items-center justify-center hover:bg-[#365132]">
              <svg width="22" height="20" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="hidden md:block md:w-3/4 ">
          <div class="grid grid-cols-4 sm:grid-cols-4 gap-4 px-8 text-[#1e1e1e] text-start text-lg font-lora">
            <div>
              <h6 class="text-[#4b6447] text-xl font-cardo">COMPANY</h6>
              <p class="text-[#1e1e1e] text-base font-lora">
                About <br/>
                Features <br/>
                Works <br/>
            ...
            <div>
              <h6 class="text-[#4b6447] text-xl font-cardo">HELP</h6>
              <p class="text-[#1e1e1e] text-base font-lora">
                Customer Support <br/>
                Delivery Details <br/>
                Terms & Conditions <br/>
            ...
            <div>
              <h6 class="text-[#4b6447] text-xl font-cardo">FAQ</h6>
              <p class="text-[#1e1e1e] text-base font-lora">
                Account <br/>
            ...
            <div>
              <h6 class="text-[#4b6447] text-xl font-cardo">RESSOURCES</h6>
              <p class="text-[#1e1e1e] text-base font-lora">
                Free eBooks <br/>
                How to - Blog <br/>
