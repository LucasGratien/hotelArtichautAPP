...
import LoginModal from "~/components/form/LoginModal.vue"; // Import du store d'authentification
...
const isLoginModalOpen = ref(false); // État de la modale de connexion
